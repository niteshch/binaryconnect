...
def test_lenet(learning_rate=0.01, n_epochs=70, nkerns=[64, 128, 256], filter_shape=2,
            batch_size=200, verbose=False, normal=False, smaller_set=True, std_normal=2):
    """
    ...
    layer4 = LogisticRegression(input=layer7.output, n_in=100, n_out=10)
    ...
    params =  params + layer11.params + layer00.params
    params =  params + layer5.params + layer6.params + layer7.params
    ...
    updates = [
        ...
        (param_i, T.cast(T.switch(T.gt(T.clip(param_i - learning_rate * grad_i, -1, 1), 0), 1, -1), theano.config.floatX))
